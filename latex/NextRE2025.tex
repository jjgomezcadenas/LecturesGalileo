...
\title[]{\vspace{60pt} \\
CERN committee for Recognised Experiments} % Change the lecture topic right here!
%\subtitle{n}
...
%\vspace*{-1mm}
%\caption{Teft-lop panel: Drawing showing the main components of the detector. Top-right: Front view of the TPC. Bottom-left: Tracking plane (TP). Bottom-right: Energy plane (EP).}
%\label{fig:next}
%\end{figure}
%\end{columns}
\end{frame}
